            ...
            <ul className="metismenu list-unstyled" id="side-menu">
              ...
              <li>
                <Link to="/collection" className="">
                  ...
                  <span>{this.props.t("Koleksi")}</span>
                </Link>
              </li>
              <li>
                <Link to="/donation" className="">
                  <i className="bx bx-wallet-alt" />
                  <span>{this.props.t("Donasi")}</span>
                </Link>
              </li>
              <li>
                <Link to="/team" className="">
                  <i className="bx bx-group" />
                  <span>{this.props.t("Tim")}</span>
                </Link>
              </li>
              <li>
                ...
                <ul className="sub-menu">
                  <li>
                    <Link to="/website/home">{this.props.t("Home")}</Link>
                  </li>
                  <li>
                    <Link to="/website/team">{this.props.t("Team")}</Link>
                  </li>
                </ul>
              </li>
              <li>
